...
// 	protoc        v3.21.6
// source: api/verfiyCode/verifyCode.proto
...
func (TYPE) Descriptor() protoreflect.EnumDescriptor {
	return file_api_verfiyCode_verifyCode_proto_enumTypes[0].Descriptor()
}

func (TYPE) Type() protoreflect.EnumType {
	return &file_api_verfiyCode_verifyCode_proto_enumTypes[0]
}
...
func (TYPE) EnumDescriptor() ([]byte, []int) {
	return file_api_verfiyCode_verifyCode_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetVerifyCodeRequest) Reset() {
	*x = GetVerifyCodeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_verfiyCode_verifyCode_proto_msgTypes[0]
...
func (x *GetVerifyCodeReply) Reset() {
	*x = GetVerifyCodeReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_verfiyCode_verifyCode_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetVerifyCodeReply) Descriptor() ([]byte, []int) {
	return file_api_verfiyCode_verifyCode_proto_rawDescGZIP(), []int{1}
}
...
var File_api_verfiyCode_verifyCode_proto protoreflect.FileDescriptor

var file_api_verfiyCode_verifyCode_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x65, 0x72, 0x66, 0x69, 0x79, 0x43, 0x6f, 0x64, 0x65,
...
var (
	file_api_verfiyCode_verifyCode_proto_rawDescOnce sync.Once
	file_api_verfiyCode_verifyCode_proto_rawDescData = file_api_verfiyCode_verifyCode_proto_rawDesc
)

func file_api_verfiyCode_verifyCode_proto_rawDescGZIP() []byte {
	file_api_verfiyCode_verifyCode_proto_rawDescOnce.Do(func() {
		file_api_verfiyCode_verifyCode_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_verfiyCode_verifyCode_proto_rawDescData)
	})
	return file_api_verfiyCode_verifyCode_proto_rawDescData
}

var file_api_verfiyCode_verifyCode_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_api_verfiyCode_verifyCode_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_verfiyCode_verifyCode_proto_goTypes = []interface{}{
...
var file_api_verfiyCode_verifyCode_proto_depIdxs = []int32{
...
func init() { file_api_verfiyCode_verifyCode_proto_init() }
func file_api_verfiyCode_verifyCode_proto_init() {
	if File_api_verfiyCode_verifyCode_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_verfiyCode_verifyCode_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_verfiyCode_verifyCode_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_verfiyCode_verifyCode_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_verfiyCode_verifyCode_proto_goTypes,
		DependencyIndexes: file_api_verfiyCode_verifyCode_proto_depIdxs,
		EnumInfos:         file_api_verfiyCode_verifyCode_proto_enumTypes,
		MessageInfos:      file_api_verfiyCode_verifyCode_proto_msgTypes,
	}.Build()
	File_api_verfiyCode_verifyCode_proto = out.File
	file_api_verfiyCode_verifyCode_proto_rawDesc = nil
	file_api_verfiyCode_verifyCode_proto_goTypes = nil
	file_api_verfiyCode_verifyCode_proto_depIdxs = nil
}
